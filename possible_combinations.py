...
from helpers import (
    ...
    get_combination_class_name_by_combination_class_id
)
...
def possible_combinations():
    ...
    combination_class_name_by_id = get_combination_class_name_by_combination_class_id(st.session_state.combination_classes)
    ...
    for combination in st.session_state.possible_combinations:
        ...
        combination_class_ids = combination["combination_class_ids"]
        combination_class_names = [combination_class_name_by_id[class_id] for class_id in combination_class_ids]
        row["Kombinasjonsklasser"] = combination_class_names
        table_rows.append(row)
    table_df = pd.DataFrame(table_rows, columns=param_columns+["Kombinasjonsklasser"])
