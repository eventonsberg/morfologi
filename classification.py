...
def classification():
    ...
    #rescaled_persistence = rescale_persistence_0_100(persistence)
    concept_scores = {cid: concept_score(cid, concepts, persistence) for cid in concepts}
    st.write(concept_scores)
    params = {
        "persistence_threshold": 0,
        "overlap_epsilon": 0,
    }
    selected_concepts = select_portfolio(concepts, persistence, params)
    st.write("Selected concepts:", selected_concepts)
